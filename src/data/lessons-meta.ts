...
export const LESSONS: LessonMeta[] = [
  {
    ...
    description_ru: 'Казахские приветствия, как представиться, простые вопросы.',
    rule_ids: ['rule_15', 'rule_25'],
    mentor_track: 'abai',
    required_level: 'A1',
  },
  {
  ...
  },
  {
    ...
    topic: 'conversation',
    difficulty: 'A2',
    description_kk: 'Дүкенде сөйлесу, баға сұрау, сауда жасасу.',
    description_ru: 'Разговор в магазине, вопросы о цене, обсуждение покупки.',
    rule_ids: ['rule_14', 'rule_12'],
    mentor_track: 'auezov',
    required_level: 'A2',
  },
  {
  ...
  },
  {
    ...
    rule_ids: ['rule_22', 'rule_07', 'rule_08', 'rule_09', 'rule_10'],
    mentor_track: 'baitursynuly',
    required_level: 'A2',
  },
  {
    ...
    description_ru: 'Сделать заказ, названия блюд.',
    rule_ids: ['rule_22', 'rule_17'],
    mentor_track: 'auezov',
    required_level: 'B1',
  },
  {
    ...
    description_ru: 'Положительная, сравнительная, эмфатическая (күшейтпелі), превосходная (асырмалы) степени.',
    rule_ids: ['rule_06'],
    mentor_track: 'baitursynuly',
    required_level: 'B1',
  },
  ...
  },
  {
    ...
    description_ru: 'Я, ты, Вы (вежл.), он/она, мы, вы (мн.), Вы (мн. вежл.), они — склонение по лицам и числам.',
    rule_ids: ['rule_15'],
    mentor_track: 'auezov',
    required_level: 'A1',
  },
  ...
  },
  {
    ...
    topic: 'grammar',
    difficulty: 'B2',
    description_kk: 'Ашық, бұйрық, шартты, қалау райлары.',
  ...
  },
  {
    ...
    topic: 'phonetics',
    difficulty: 'A1',
    description_kk: 'Ә, ғ, қ, ң, ө, ұ, ү, һ, і — 9 тән дыбысты меңгеру.',
  ...
  },
  {
    ...
    topic: 'orthography',
    difficulty: 'A2',
    description_kk: 'Сөйлем басы, жалқы есімдер, географиялық атаулар, мекемелер мен ұйымдардың аттары.',
    description_ru: 'Начало предложения, имена собственные, географические названия, наименования учреждений.',
    rule_ids: ['rule_19'],
    mentor_track: 'baitursynuly',
    required_level: 'A2',
  },
  {
    ...
    topic: 'grammar',
    difficulty: 'B2',
    description_kk: 'Осы, өткен, келер шақ есімшелері: оқитын (дағдылы), оқыған (өткен), оқыр (келер).',
    description_ru: 'Причастия: оқитын (привычное / настояще-будущее), оқыған (прошедшее), оқыр (будущее).',
    rule_ids: ['rule_20'],
    mentor_track: 'baitursynuly',
    required_level: 'B2',
  },
...
> = {
  ...
  baitursynuly: {
    ...
    name_ru: 'Байтурсынулы',
    track_kk: 'Байтұрсынұлымен жол',
    track_ru: 'Путь с Байтурсынулы',
    accent: 'emerald',
  },
  auezov: {
    key: 'auezov',
